...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-navy-500 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-navy-700 text-white shadow-soft hover:bg-navy-800',
        secondary: 'bg-white text-navy-700 shadow-sm hover:bg-slate-50',
        outline: 'border border-navy-200 bg-transparent text-navy-700 hover:bg-navy-50',
        ghost: 'hover:bg-slate-100 text-slate-700',
        saffron: 'bg-saffron-500 text-white shadow-soft hover:bg-saffron-600',
      },
      size: {
